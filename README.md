...
The core library itself is well tested and has more than 93% of the code covered by unit tests and integration tests and tries to be SCPI-99 compliant as much as possible.
